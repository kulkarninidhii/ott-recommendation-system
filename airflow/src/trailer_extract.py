...
def fetch_trailer_and_thumbnail(title, type, directors, actors, api_key):
    ...
    if type=='Movie':
        ...
        ## Split directors and actors for multiple entries
        ...
        for result in search_response['results']:
            ...
            # Check matches in director and actor
            ...
            # Check for actor matches in the cast section
            found_actor = False
            ...
            # If a director or a main actor matches, consider this a successful match
